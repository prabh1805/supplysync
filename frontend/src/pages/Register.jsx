    ...
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input style={styles.input} placeholder="Tenant ID (UUID)" value={form.tenantId} onChange={update('tenantId')} required />
...
const styles = {
  ...
  halfInput: { width: '48%', padding: '12px', marginBottom: '16px', border: '1px solid #ddd', borderRadius: '6px', fontSize: '14px', boxSizing: 'border-box' },
